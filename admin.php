...
<section class = "display-product-table">
    ...
    $select_products = mysqli_query($con,"SELECT * FROM product");
            ...
            <tr>
                ...
                <td>
                <a href="admin.php?delete=<?php echo $row['product_id']; ?>"class="delete-btn" 
                onclic="return confirm('are your sure you want to delete this ?')"> <i 
                class="fas fa-trash"></i> delete </a>
                <a href="admin.php?edit=<?php echo $row['product_id']; ?>" class = "option-btn"><i 
